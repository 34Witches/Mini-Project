...
class Demux16Way():
    ...
    def _setup(self):
        ...
        self.gate0.select = self._select[0:3]
        ...
        self.gate1.select = self._select[3:4]
        self.outa = self.gate1.outaf()
        self.outb = self.gate1.outbf()
        self.gate2.a = self._c
        self.gate2.select = self._select[3:4]
        self.outc = self.gate2.outaf()
        self.outd = self.gate2.outbf()
        self.gate3.a = self._d
        self.gate3.select = self._select[3:4]
        self.oute = self.gate3.outaf()
        self.outf = self.gate3.outbf()
        self.gate4.a = self._e
        self.gate4.select = self._select[3:4]
        self.outg = self.gate4.outaf()
        self.outh = self.gate4.outbf()
        self.gate5.a = self._f
        self.gate5.select = self._select[3:4]
        self.outi = self.gate5.outaf()
        self.outj = self.gate5.outbf()
        self.gate6.a = self._g
        self.gate6.select = self._select[3:4]
        self.outk = self.gate6.outaf()
        self.outl = self.gate6.outbf()
        self.gate7.a = self._h
        self.gate7.select = self._select[3:4]
        self.outm = self.gate7.outaf()
        self.outn = self.gate7.outbf()
        self.gate8.a = self._i
        self.gate8.select = self._select[3:4]
